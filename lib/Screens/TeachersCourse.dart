...
class TeachersCourse extends StatefulWidget {
  _AllCoursesState createState() => _AllCoursesState();

}

class _AllCoursesState extends State<TeachersCourse> {
  ...
  Future getAllCourseList() async {
    final responce = await http.get("http://course.appstic.xyz/getcourse/2");
    print(responce.body);
